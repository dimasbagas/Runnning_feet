...
class _MapsState extends State<Maps> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Rute Lari #${widget.lariId}")),
      body: SafeArea(
              ...
              return SfMaps(
                layers: [
                  MapTileLayer(
                    ...
                    initialMarkersCount: routePoints.length, // Menentukan jumlah marker
                    markerBuilder: (BuildContext context, int index) {
                      ...
                      return MapMarker(
                        ...
                        child: Icon(
                          ...
                          size: index == 0 || index == routePoints.length - 1 ? 30 : 15,
                        ),
                      );
                    },
                    sublayers: [
